...
tagDF_rel_grps$tagid_inclu_MCN <- tagDF_rel_grps$tagid %in% unique((obs_rel_grps10 %>% filter(dat_grp=="mcn_det"))$tagid)


saveRDS(tagDF_rel_grps,"comp_files/tags_comb_inclu_9825.rds")
