...
get_raw_DET_LGRRRR_tab <- function(tags_comb_raw_in){
  
  LGR_rel_tb_w <- tags_comb_raw_in %>% 
    filter(reartype!="U" & rel_at_LGR & reartype!="H" & esutype!="SR_Sock") %>%  
